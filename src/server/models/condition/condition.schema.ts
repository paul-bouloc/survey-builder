...
ConditionSchema.discriminator(ConditionOperator.NOT_EQUALS, SimpleConditionSchema)
...
ConditionSchema.discriminator(ConditionOperator.GREATER_THAN, SimpleConditionSchema)
ConditionSchema.discriminator(
  ConditionOperator.GREATER_THAN_OR_EQUALS,
  SimpleConditionSchema
)
ConditionSchema.discriminator(ConditionOperator.LESS_THAN, SimpleConditionSchema)
ConditionSchema.discriminator(
